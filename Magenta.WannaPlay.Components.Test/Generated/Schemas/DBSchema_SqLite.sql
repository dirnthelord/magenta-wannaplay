...
create table "BookingSlot" (Id  integer, FromTime DATETIME, ToTime DATETIME, BookedAt DATETIME, Facility_id INTEGER, Resident_id INTEGER, BookedBy_id INTEGER, primary key (Id))
